...
//Twitter keys and tokens must be inserted bellow. These keys can be found at https://apps.twitter.com
...
class TwitterOAuth
{
	...
	public function get($call, array $getParams = null)
	{
		...
		if (!isset($result['errors']) && ( !$cache || time() - $cache[$this->getParams['screen_name']]['time'] > 24*3600) ) {
